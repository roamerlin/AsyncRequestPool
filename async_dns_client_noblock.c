...
int dns_build_request(struct dns_header *header, struct dns_question *question,
  ...
  int question_s =
      question->length + sizeof(question->qtype) + sizeof(question->qclass);
...
static void dns_parse_name(unsigned char *chunk, unsigned char *ptr, char *out,
                           int *len) {
...
static int dns_parse_response(char *buffer, struct dns_item **domains) {
  ...
  int cnt = 0;
  struct dns_item *list =
      (struct dns_item *)calloc(answers, sizeof(struct dns_item));
  if (list == NULL) {
    return -1;
  }
...
int dns_client_commit(const char *domain) {
  ...
  int slen = sendto(sockfd, request, req_len, 0, (struct sockaddr *)&dest,
...
char *domain[] = {
    "www.ntytcp.com",   "bojing.wang",         "www.baidu.com",
    "tieba.baidu.com",  "news.baidu.com",      "zhidao.baidu.com",
    "music.baidu.com",  "image.baidu.com",     "v.baidu.com",
    "map.baidu.com",    "baijiahao.baidu.com", "xueshu.baidu.com",
    "cloud.baidu.com",  "www.163.com",         "open.163.com",
    "auto.163.com",     "gov.163.com",         "money.163.com",
    "sports.163.com",   "tech.163.com",        "edu.163.com",
    "www.taobao.com",   "q.taobao.com",        "sf.taobao.com",
    "yun.taobao.com",   "baoxian.taobao.com",  "www.tmall.com",
    "suning.tmall.com", "www.tencent.com",     "www.qq.com",
    "www.aliyun.com",   "www.ctrip.com",       "hotels.ctrip.com",
    "hotels.ctrip.com", "vacations.ctrip.com", "flights.ctrip.com",
    "trains.ctrip.com", "bus.ctrip.com",       "car.ctrip.com",
    "piao.ctrip.com",   "tuan.ctrip.com",      "you.ctrip.com",
    "g.ctrip.com",      "lipin.ctrip.com",     "ct.ctrip.com"};
